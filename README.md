...
Сейчас очень нужна помощь с моделированием системы, почитать о котором можно в разделе [Creating models](https://docs.djangoproject.com/en/1.11/intro/tutorial02/#creating-models) документации Django 1.11. 
